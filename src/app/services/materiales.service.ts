...
export class MaterialesService {
  ...
  getReportAllByStatus(fill){
    return this.http.post(`${this.API_URI}/reportes/detallado/4`, fill);
  }

  getReportAllByTipo(fill){
    return this.http.post(`${this.API_URI}/reportes/detallado/3`, fill);
  }

  getReportAllByTipoTec(fill){
    return this.http.post(`${this.API_URI}/reportes/detallado/1`, fill);
  }

  getReportAllByStatusTec(fill){
    return this.http.post(`${this.API_URI}/reportes/detallado/2`, fill);
  }

  getReportAllSameDay(fill){
    return this.http.post(`${this.API_URI}/reportes/detallado/5`, fill);
  }

  getReportAll2ndDay(fill){
    return this.http.post(`${this.API_URI}/reportes/detallado/6`, fill);
  }

  getReportAll3rdDay(fill){
    return this.http.post(`${this.API_URI}/reportes/detallado/7`, fill);
  }

  getAVG(){
    return this.http.get(`${this.API_URI}/reportes/detallado/8`);
  }
