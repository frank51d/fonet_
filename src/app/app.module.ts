...
import { ReporteDetComponent } from './components/reportes/reporte-det/reporte-det.component';
...
const routes: Routes = [
  ...
  { path: 'reportes/detallado', component: ReporteDetComponent, canActivate: [guard], data: { expectedRol: ['admin']}},
